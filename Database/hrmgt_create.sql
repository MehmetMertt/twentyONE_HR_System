  ...
  --
  ALTER TABLE `ABSENCE`
    ADD CONSTRAINT `ABSENCE_ibfk_1` FOREIGN KEY (`employeeid`) REFERENCES `EMPLOYEE` (`id`) ON DELETE CASCADE,
    ADD CONSTRAINT `ABSENCE_REASON` FOREIGN KEY (`absencereason`) REFERENCES `ABSENCE_REASON` (`id`) ON DELETE CASCADE,
    ADD CONSTRAINT `ABSENCE_STATUS` FOREIGN KEY (`status`) REFERENCES `ABSENCE_STATUS` (`id`) ON DELETE CASCADE;
